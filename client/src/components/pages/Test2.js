...
const [checkgender,setCheckgender] = useState("female");
  ...
  async function predict() {
    model = await tmImage.load(modalURL, metadataURL);
      ...
      <main>
        ...
        <div className="mt-3 container file-upload">
          ...
          <div className="file-upload-content">
            <img className="file-upload-image rounded-circle" id="face-image" src="#" alt="your image" />
            <a className="heart" style="font-size: 27px; color: rgb(255, 193, 220);">♥</a>
            <img className="file-result-image rounded-circle" id="result-image" src="" alt="result image" />
