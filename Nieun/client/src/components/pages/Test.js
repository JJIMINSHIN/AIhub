...
const Test = () => {
  ...
  async function predict() {
    ...
    let image = document.getElementById('face-imgage');
    ...
    let title = "<div class='" + prediction[0].className + "-animal-title'>" + resultTitle + "</div>"
    let explain = "<div class='animal-explain pt-2'>" + resultExplain + "</div>"
    let celeb = "<div class='" + prediction[0].className + "-animal-celeb pt-2 pb-2'>" + resultCeleb + "</div>"
      ...
      <main>
        ...
        <div className="mt-3 container file-upload">
          <div className="image-upload-wrap">
            ...
            <input className="file-upload-input" type='file' onChange={(file) => {
              handleChange()
            }} accept="image/*" />
